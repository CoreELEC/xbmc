...
constexpr uint32_t PLAYER_PROCESS_AML_FPS_INFO       = PLAYER_PROCESS_START + 33;
constexpr uint32_t PLAYER_PROCESS_AML_FPS_DROP       = PLAYER_PROCESS_START + 34;
constexpr uint32_t PLAYER_PROCESS_AUDIOCHANNELS_SINK = PLAYER_PROCESS_START + 35;
